...
public class PerpustakaanMain {
    public static void main(String[] args) {
        ...
        // ===================== TEKNOLOGI =====================
        System.out.println("\n[TEKNOLOGI]");
        System.out.println("\"" + teknologi[0].getNamaBuku() + "\" mendapat royalti \"10%\" : " + teknologi[0].hitungRoyalti(50000));
        System.out.println("\"" + teknologi[1].getNamaBuku() + "\" mendapat royalti \"15%\" : " + teknologi[0].hitungRoyalti(50000, 15));

        // ===================== FILSAFAT =====================
        System.out.println("\n[FILSAFAT]");
        System.out.println("\"" + filsafat[0].getNamaBuku() + "\" mendapat royalti \"10%\" : " + filsafat[0].hitungRoyalti(60000));
        System.out.println("\"" + filsafat[1].getNamaBuku() + "\" mendapat royalti \"12%\" : " + filsafat[0].hitungRoyalti(60000, 12));

        // ===================== SEJARAH =====================
        System.out.println("\n[SEJARAH]");
        System.out.println("\"" + sejarah[0].getNamaBuku() + "\" mendapat royalti \"10%\" : " + sejarah[0].hitungRoyalti(55000));
        System.out.println("\"" + sejarah[1].getNamaBuku() + "\" mendapat royalti \"18%\" : " + sejarah[0].hitungRoyalti(55000, 18));

        // ===================== AGAMA =====================
        System.out.println("\n[AGAMA]");
        System.out.println("\"" + agama[0].getNamaBuku() + "\" mendapat royalti \"10%\" : " + agama[0].hitungRoyalti(40000));
        System.out.println("\"" + agama[1].getNamaBuku() + "\" mendapat royalti \"20%\" : " + agama[1].hitungRoyalti(40000, 20));

        // ===================== PSIKOLOGI =====================
        System.out.println("\n[PSIKOLOGI]");
        System.out.println("\"" + psikologi[0].getNamaBuku() + "\" mendapat royalti \"10%\" : " + psikologi[0].hitungRoyalti(70000));
        System.out.println("\"" + psikologi[1].getNamaBuku() + "\" mendapat royalti \"25%\" : " + psikologi[1].hitungRoyalti(70000, 25));

        // ===================== POLITIK =====================
        System.out.println("\n[POLITIK]");
        System.out.println("\"" + politik[0].getNamaBuku() + "\" mendapat royalti \"10%\" : " + politik[0].hitungRoyalti(65000));
        System.out.println("\"" + politik[1].getNamaBuku() + "\" mendapat royalti \"30%\" : " + politik[1].hitungRoyalti(65000, 30));

        // ===================== FIKSI =====================
        System.out.println("\n[FIKSI]");
        System.out.println("\"" + fiksi[0].getNamaBuku() + "\" mendapat royalti \"10%\" : " + fiksi[0].hitungRoyalti(80000));
        System.out.println("\"" + fiksi[1].getNamaBuku() + "\" mendapat royalti \"35%\" : " + fiksi[1].hitungRoyalti(80000, 35));
    }
}
